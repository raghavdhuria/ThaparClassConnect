      ...
      {spinner ? (
        ...
        <>
          <Header
            ...
            style="bg-gradient-to-r from-[#3A4BE7] to-[#929BEB]"
          />
            ...
            <div className=" container">
              <div className="pagecontent">
                ...
                <div className="flex justify-center text-center">
                  <div
                    className="bg-red-500 min-w-80 text-white rounded-lg shadow-lg flex flex-col justify-between h-40 "
              ...
              <div className="fixed inset-0 bg-gray-800 bg-opacity-90 flex justify-center items-center z-50">
                <div className="bg-white dark:bg-slate-800 border rounded-lg shadow-lg p-6 max-w-md mx-4 sm:mx-auto">
                  ...
                  <form onSubmit={submitHandler} className="mt-4 space-y-4">
                    <input
                      className="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:ring focus:border-red-300 dark:bg-slate-700"
                      type="text"
                      name="name"
                      value={formData.name}
