                ...
                <div className="bg-white dark:bg-slate-800  px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className="mt-5 sm:mt-6 flex justify-center">
                      ...
                      <input
                        type="submit"
                        className="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-red-600 hover:bg-red-700 ml-4 hover:cursor-pointer"
                      />
                    </div>
                  </form>
                </div>
            ...
            <div className="flex justify-center items-center min-h-screen text-center bg-gray-500 bg-opacity-90 transition-opacity">
              <div className="bg-white rounded-lg dark:bg-slate-800 shadow-xl w-full max-w-lg mx-4 sm:mx-auto">
                ...
                <div className="flex justify-end border-t border-gray-200 p-4">
                  ...
                  <button type="button" className="ml-2 px-4 py-2 bg-red-500 text-white rounded hover:bg-red-600" onClick={() => {/* Code to send message and close the modal */ }}>
                    Send Message
                  </button>
                </div>
              </div>
          ...
          <div className="dark:bg-slate-900 dark:text-white">
            ...
            <section className="container p-6  " >
              ...
              <div className="flex justify-center text-center">
                <div className="bg-red-500 min-w-80 text-white rounded-lg shadow-lg flex flex-col justify-between h-40"
                  ...
                  <div className="flex justify-center border-t items-center py-2 cursor-pointer hover:bg-red-600 rounded-b-lg">
                    Add Schedule
                  </div>
                </div>
              </div>
                          ...
                          >
                            ...
                            <div className="p-4 bg-gray-50 rounded-b-lg dark:bg-slate-800 border ">
                              ...
                              <div className="flex justify-between">
                                ...
                                <button
                                  type="button"
                                  className="relative bg-red-500 text-white rounded p-2 hover:bg-red-600"
                                  onClick={() => {
